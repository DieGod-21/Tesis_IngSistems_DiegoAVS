 ...
 * studentStore.ts
 *
 * Capa de persistencia para estudiantes (localStorage mock).
 * Separada de la interfaz Student para respetar la arquitectura
 * de capas: el modelo de dominio no conoce la infraestructura.
 *
